...
class TestEscalationPolicy(unittest.TestCase):
  def test_initialization(self):
    ...
    self.assertEqual(escalation_policy.policies[monitored_service.service_name], escalation_policy_monitored_service)
...
class TestPagerService(unittest.TestCase):
  ...
  def testReceiveAlert(self):
    ...
    # TODO: test that the timer acknowledgment delay was set to 15 minutes
